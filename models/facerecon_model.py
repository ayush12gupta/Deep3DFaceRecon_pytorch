...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            # loss weights
            parser.add_argument('--w_feat', type=float, default=7, help='weight for feat loss')
            parser.add_argument('--w_color', type=float, default=3.92, help='weight for loss loss')
            parser.add_argument('--w_reg', type=float, default=5.0e-3, help='weight for reg loss')
            parser.add_argument('--w_id', type=float, default=2.0, help='weight for id_reg loss')
    ...
    def forward(self):
        ...
        #     self.pred_vertex, self.facemodel.face_buf, feat=None)
